...
final class TestLoggerTest {
    ...
    abstract static class JdkLoggerTests {
        ...
        @Test
        @DisplayName("parent handler added")
        void testParentHandlerAdded() {
            java.util.logging.Handler handler = mock(java.util.logging.Handler.class);
        ...
        @Test
        @DisplayName("parent handler replaced")
        void testParentHandlerReplaced() {
            java.util.logging.Handler handler = mock(java.util.logging.Handler.class);
    ...
    abstract static class Log4jLoggerTests {
        ...
        @Test
        @DisplayName("parent appender added")
        void testParentAppenderAdded() {
            Log4jNullAppender appender = spy(Log4jNullAppender.create("MockAppender"));
        ...
        @Test
        @DisplayName("parent appender replaced")
        void testParentAppenderReplaced() {
            Log4jNullAppender appender = spy(Log4jNullAppender.create("MockAppender"));
