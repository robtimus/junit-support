...
/**
 * {@code LogOnFailure} can be used to suppress logging.
 * However, if a test fails, all logging that had been suppressed will occur at the end of the failed test.
 * <p>
 * To suppress logging, add a logger field (static or not) to your test class and annotate it with {@code LogOnFailure}.
 ...
 * @since 3.0
 */
@ExtendWith(LogOnFailureExtension.class)
